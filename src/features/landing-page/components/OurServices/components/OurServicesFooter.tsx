  ...
  return (
    <div className='flex flex-col lg:flex-row justify-evenly items-center gap-16 lg:gap-0 py-16 px-10'>
      ...
      <div className='flex flex-col gap-8'>
        <h4 className='font-ivy text-3xl sm:text-4xl text-[#F2EBDC] text-center lg:text-start font-semibold leading-normal'>
          Make parenting a<br />
          more{' '}
      ...
      <div className='flex flex-col gap-8 items-start max-w-lg text-[#EEEBE3] text-lg sm:text-lg lg:text-xl text-left'>

        <div className='flex items-start lg:items-center gap-6'>
          <Image src='/icons/iconito.svg' width={50} height={50} alt='icon' />
        ...
        <div className='flex items-start lg:items-center gap-6'>
          <Image src='/icons/iconito.svg' width={50} height={50} alt='icon' className='rotate-45' />
