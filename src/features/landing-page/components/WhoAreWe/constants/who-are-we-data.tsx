    ...
    education: (
      <div className='text-justify'>
        ...
        <ul className='list-disc pl-4 mt-2'>
          <li>Licensed Psychologist (Universidad de Buenos Aires, Argentina) - Honors</li>
          <li>Master in Clinical Psychology (Universidad de Buenos Aires, Argentina)</li>
          <li>Certified in ADOS, ADI-R & Natural Nutrition (IATENA)</li>
          <li>Bachelor's in Psychology (USA), Certified Life Coach, Incredible Years Certified</li>
        </ul>
      </div>
    )
